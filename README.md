...
**ServerPackages=InstaGibPlus5E**  
**ServerActors=InstaGibPlus5E.NewNetServer**  
**ServerActors=InstaGibPlus5E.PureStats**  

<b>It is highly recommended to set your server's tickrate to 100.</b>

# Usage
For InstaGib, make sure the mutator **InstaGibPlus5E.NewNetIG** is loaded via your map vote configuration or during server launch.
...
2. Use `git clone https://github.com/utspect/InstaGibPlus InstaGibPlus5E` to clone the repo
3. Navigate to the newly created directory `InstaGibPlus5E`
4. Execute `build.bat`
