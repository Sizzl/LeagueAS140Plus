...
**ServerPackages=InstaGibPlus8C**  
**ServerActors=InstaGibPlus8C.NewNetServer**  
**ServerActors=InstaGibPlus8C.PureStats**  

<b>It is highly recommended to set your server's tickrate to 100.</b>

# Usage
For InstaGib, make sure the mutator **InstaGibPlus8C.NewNetIG** is loaded via your map vote configuration or during server launch.
...
2. Use `git clone https://github.com/utspect/InstaGibPlus InstaGibPlus8C` to clone the repo
3. Navigate to the newly created directory `InstaGibPlus8C`
4. Execute `build.bat`
